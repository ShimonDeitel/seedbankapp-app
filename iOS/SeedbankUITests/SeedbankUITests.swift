...
final class SeedbankUITests: XCTestCase {
    ...
    func testAddFlow() {
        ...
        nameField.tap()
        nameField.typeText("UI Test Packet")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Packet"].waitForExistence(timeout: 2))
    }
    ...
    func testKeyboardDismissOnTapOutside() {
        ...
        app.staticTexts["Add Packet"].tap()
